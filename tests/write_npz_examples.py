...
os.system('zipalign -f 64 examples.npz examples_64_byte_aligned.npz')
os.system('zipalign -f 64 examples_little_endian.npz examples_little_endian_64_byte_aligned.npz')
os.system('zipalign -f 64 examples_big_endian.npz examples_big_endian_64_byte_aligned.npz')
